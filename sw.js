const CACHE='galizische-bahn-v0.6.1-ux1';
const ASSETS=['./','./index.html','./app.css','./app.js','./data.js','./store.js','./routing.js','./payment.js','./manifest.webmanifest','./icons/favicon-32.png','./icons/apple-touch-icon.png','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-icon-512.png'];
